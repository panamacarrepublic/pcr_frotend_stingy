    ...
    <StepFrame
      ...
      left={
        <Box sx={gridSx}>
          ...
          <RhfSelect name="condition" label={f.condition} info options={toSelectOptions(conditionLabels)} />
          <RhfSelect
          ...
          />
          <RhfSelect name="province" label={f.province} info options={provinceOptions} />
          <RhfTextField name="district" label={f.district} placeholder={p.district} info />
        </Box>
      }
    />
  );
